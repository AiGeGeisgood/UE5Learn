...
#include "XGSampleTTSReqType.generated.h"

/**
 *	FXGXunFeiTTSReqCommonInfo
 */
USTRUCT()
struct XGSAMPLEXFLINK_API FXGXunFeiTTSReqCommonInfo
{
	GENERATED_BODY()

	friend class UXGSampleTTSAsyncAction;
...
struct XGSAMPLEXFLINK_API FXGXunFeiTTSReqBusinessInfo
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct XGSAMPLEXFLINK_API FXGXunFeiTTSReqDataInfo
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct XGSAMPLEXFLINK_API FXGXunFeiTTSReqInfo
{
	GENERATED_BODY()
