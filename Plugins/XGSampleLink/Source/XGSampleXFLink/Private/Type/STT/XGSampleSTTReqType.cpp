...
FString FXGSampleSTTReqInfo::GenerateRequireParams(FString InAppID, FString InAPIKey)
{
    FString RetStr = TEXT("");
...
FString FXGSampleSTTReqInfo::GenerateSigna(const FString& InAppid, const FString& InTS, const FString& InAPIKey)
{
